...
cor_blomqvist_mat <- cor_mat_list[[5]]; cor_MI_mat <- cor_mat_list[[6]];
cor_dist_mat <- cor_mat_list[[7]]; cor_XI_mat <- cor_mat_list[[8]];
```

```{r}
load("CD4_seurat_corrq.RData")
...
for (i in 1:nrow(cor_contrast_ind1)){
  ...
  plot(sub_dat[,index1], sub_dat[,index2], asp = T,
...
```{r}
dense_ind <- rbind(c(345, 13), c(1375, 18), c(45, 1),
                   c(23, 2), c(1282, 18), c(354, 3), c(219, 14))

dense_mat <- matrix(nrow = nrow(dense_ind), ncol = 8)
for (i in 1:nrow(dense_ind)){
  row <- dense_ind[i,1]; col <- dense_ind[i,2];
  h <- c()
  for (j in 1:length(cor_mat_list)){
    if (j == 4){
      h <- c(h, NA)
      next
    }
    cur_mat <- cor_mat_list[[j]]
...
dense_title <- 
  c(paste(paste0("Pearson of ", round(cor_pearson_mat[dense_ind[1,1], dense_ind[1,2]], 3),
                  ...
                  "\n",
                  paste0("Beta of ", round(cor_blomqvist_mat[dense_ind[1,1], dense_ind[1,2]], 3))),
    paste(paste0("Spearman of ", round(cor_spearman_mat[dense_ind[2,1], dense_ind[2,2]], 3),
                         "  NMI of ", round(cor_MI_mat[dense_ind[2,1], dense_ind[2,2]], 3)),
                  "\n",
                  paste0("Beta of ", round(cor_blomqvist_mat[dense_ind[2,1], dense_ind[2,2]], 3))),
    paste(paste0("XI of ", round(cor_XI_mat[dense_ind[3,1], dense_ind[3,2]], 3),
                 "  Dist Cor of ", round(cor_dist_mat[dense_ind[3,1], dense_ind[3,2]], 3)),
                  "\n",
                  paste0("NMI of ", round(cor_MI_mat[dense_ind[3,1], dense_ind[3,2]], 3),
                         " Beta of", round(cor_blomqvist_mat[dense_ind[3,1], dense_ind[3,2]], 3))),
    paste(paste0("XI of ", round(cor_XI_mat[dense_ind[4,1], dense_ind[4,2]], 3),
                 "  NMI of ", round(cor_MI_mat[dense_ind[4,1], dense_ind[4,2]], 3)),
                  "\n",
                  paste0("Pearson of ", round(cor_pearson_mat[dense_ind[4,1], dense_ind[4,2]], 3),
                         "  Beta of ", round(cor_blomqvist_mat[dense_ind[4,1], dense_ind[4,2]], 3))),
    paste(paste0("Spearman of ", round(cor_spearman_mat[dense_ind[5,1], dense_ind[5,2]], 3),
                 "  XI of ", round(cor_XI_mat[dense_ind[5,1], dense_ind[5,2]], 3)),
                  "\n",
          paste0("Pearson of ", round(cor_pearson_mat[dense_ind[5,1], dense_ind[5,2]], 3))),
    ...
    paste(paste0("XI of ", round(cor_XI_mat[dense_ind[7,1], dense_ind[7,2]], 3),
                 "  Dist Cor of ", round(cor_dist_mat[dense_ind[7,1], dense_ind[7,2]], 3)),
                  "\n",
          paste0("Beta of ", round(cor_blomqvist_mat[dense_ind[7,1], dense_ind[7,2]], 3)))
    )
```
