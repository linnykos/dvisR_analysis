...
```{r}
load("PCA_seurat_quantile2.RData")
...
```{r}
dense_ind <- rbind(c(335, 28), c(11, 1), c(24, 3), c(32, 3),
                   c(432, 336), c(196, 136), c(479, 66),
                   c(333, 131), c(446, 30), c(131, 46))

dense_title <- 
  c(paste(paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
                         "  Dist. Cor of ", round(cor_dist_mat[index1, index2], 3)),
                  "\n",
                  paste0("Beta of ", round(cor_blomqvist_mat[index1, index2], 3),
                         "  XI of ", round(cor_XI_mat[index1, index2], 3))),
    paste(paste0("Spearman of ", round(cor_spearman_mat[index1, index2], 3),
                         "  Hoeff D of ", round(cor_hoeffd_mat[index1, index2], 3)),
                  "\n",
                  paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
                         "  MI of ", round(cor_MI_mat[index1, index2], 3))),
    paste(paste0("Spearman of ", round(cor_spearman_mat[index1, index2], 3),
                         "  Hoeff D of ", round(cor_hoeffd_mat[index1, index2], 3)),
                  "\n",
                  paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
    ...
    paste(paste0("Spearman of ", round(cor_spearman_mat[index1, index2], 3),
                  ...
                  "\n",
                  paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
                         "  Beta of ", round(cor_blomqvist_mat[index1, index2], 3))),
    paste(paste0("Spearman of ", round(cor_spearman_mat[index1, index2], 3),
                         "  Dist Cor of ", round(cor_dist_mat[index1, index2], 3)),
                  "\n",
                  paste0("XI of ", round(cor_XI_mat[index1, index2], 3),
                         "  Beta of ", round(cor_blomqvist_mat[index1, index2], 3))),
    paste(paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
                         "  Dist Cor of ", round(cor_dist_mat[index1, index2], 3)),
                  "\n",
                  paste0("XI of ", round(cor_XI_mat[index1, index2], 3))),
    paste(paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
                         "  Hoeff of ", round(cor_hoeffd_mat[index1, index2], 3)),
                  "\n",
                  paste0("XI of ", round(cor_XI_mat[index1, index2], 3))),
    paste(paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
                         "  Hoeff of ", round(cor_hoeffd_mat[index1, index2], 3)),
                  ...
                  paste0("XI of ", round(cor_XI_mat[index1, index2], 3))),
    paste(paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
                         "  Spearman of ", round(cor_spearman_mat[index1, index2], 3)),
                  "\n",
                  paste0("XI of ", round(cor_XI_mat[index1, index2], 3),
                         "  Beta of ", round(cor_blomqvist_mat[index1, index2], 3))))
```
...
plot(sub_dat[,index1], sub_dat[,index2], col = sub_cluster_labels, pch = 16,
     xlim = c(-0.5, 0.5), ylim = c(-0.5, 0.5))
```

- It does make sense that Pearson correlation is low, but distance correlation seems to be unusual as there is a big cluster in the plot. Beta seems to be appropriate if we divide the plot into four dimensions, and they might be equal.
...
- Spearman and Hoeff D show the measurement of monotonic relationship in the plot, so there is a big cluster vertically, so it would have low value. Pearson seems to be unexpected as the cluster is vertical. 
...
- It seems equivalent to the previous plot.
...
- There are few points off the clustering and scattered randomly, so it would decrease the Pearson's correlation. Also, Beta seems to be fine because of the cluster.
...
- It is worth noting that the plot of vertical line could have higher value of XI and beta.
...
- The plot seems to have a right triangle, and it has a high value of XI. Also, the weird shape of right triangle confuses the linear shape, so it would have low value of pearson.

```{r}
index1 <- dense_ind[8, 1]; index2 <- dense_ind[8, 2];
plot(sub_dat[,index1], sub_dat[,index2], col = sub_cluster_labels, asp = T,
     pch = 16, xlab = paste0(colnames(sub_dat)[index1], ", (", index1, ")"),
     ylab = paste0(colnames(sub_dat)[index2], ", (", index2, ")"),
     main = paste(paste0("Pearson of ", round(cor_pearson_mat[index1, index2], 3),
...
```{r}
index1 <- dense_ind[9, 1]; index2 <- dense_ind[9, 2];
plot(sub_dat[,index1], sub_dat[,index2], col = sub_cluster_labels, asp = T,
     pch = 16, xlab = paste0(colnames(sub_dat)[index1], ", (", index1, ")"),
     ylab = paste0(colnames(sub_dat)[index2], ", (", index2, ")"),
     main = paste(paste0("Spearman of ", round(cor_spearman_mat[index1, index2], 3),
                  ...
                  "\n",
                  paste0("XI of ", round(cor_XI_mat[index1, index2], 3),
                         "  Pearson of ", round(cor_pearson_mat[index1, index2], 3)))
     )
```

- The plot similar to this one is seen before, but it is noticeable that it has the same trend of having high value of XI even if the points of the vertical line scattered further.
...
for (i in 1:nrow(dense_ind)){
  index1 <- dense_ind[i, 1]; index2 <- dense_ind[i, 2];
  bin <- hexbin(sub_dat[,index1], sub_dat[,index2], xbins = 40)
