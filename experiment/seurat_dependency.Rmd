...
2. When comparing the dependency measures, find the 20% and 80% percentile of each measure to set threshold (it can change)
3. Comment on each dependency measure, I will include math formula. Also, in pattern give a comment why they have contrast coefficients.

For next, there is another dataset to explore. Then, going back to the simulation.
...
# RNA_mat <- t(as.matrix(RNA_dat@scale.data))
