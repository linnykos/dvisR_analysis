...
diff_pearson_ind <- which(diff_pearson == max(diff_pearson, na.rm = T),
                         arr.ind = T)
...
for (i in 1:length(cell_labels)){
  ...
  plot(sub_dat[,diff_idx1], sub_dat[,diff_idx2], asp = T,
      ...
      ylab = paste0(colnames(sub_dat)[diff_idx2], ", (", diff_idx2, ")"), 
      main = paste0("Correlation of ",
                    round(pearson_array[diff_idx1, diff_idx2, i], 3),
                    "\nCell_type: ", cell_labels[i]),
...
diff_spearman_ind <- which(diff_spearman == max(diff_spearman, na.rm = T),
                         arr.ind = T)
...
for (i in 1:length(cell_labels)){
  ...
  plot(sub_dat[,diff_idx1], sub_dat[,diff_idx2], asp = T,
      ...
      ylab = paste0(colnames(sub_dat)[diff_idx2], ", (", diff_idx2, ")"), 
      main = paste0("Correlation of ",
                    round(spearman_array[diff_idx1, diff_idx2, i], 3),
                    "\nCell_type: ", cell_labels[i]),
...
diff_kendall_ind <- which(diff_kendall == max(diff_kendall, na.rm = T),
                         arr.ind = T)
...
for (i in 1:length(cell_labels)){
  ...
  plot(sub_dat[,diff_idx1], sub_dat[,diff_idx2], asp = T,
      ...
      ylab = paste0(colnames(sub_dat)[diff_idx2], ", (", diff_idx2, ")"), 
      main = paste0("Correlation of ",
                    round(kendall_array[diff_idx1, diff_idx2, i], 3),
                    "\nCell_type: ", cell_labels[i]),
      xlim = c(-1.5, 3), ylim = c(-2, 4))
}
```
...
plot(sub_full[, diff_idx1], sub_full[, diff_idx2], asp = T, pch = 16,
     ...
     ylab = paste0(colnames(sub_dat)[diff_idx2], ", (", diff_idx2, ")"),  
     main = paste0("Correlation of ",
                   round(discretize2d(as.matrix(sub_full[, diff_idx1]),
